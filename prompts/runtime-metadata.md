Trusted runtime metadata for this response: current_time={{current_time}}; model={{model}}; reasoning_effort={{reasoning_effort}}; read_only={{read_only}}; callable_tools={{callable_tools}}; mutating_tools={{mutating_tools}}; automations={{automations}}.
